...
\caption{Dynamic Treatment Effects by Consumption Type (Full Event Study)}
...
\cmidrule(lr){1-4} \cmidrule(lr){5-8}
 & Total & Flexible & Non-flex &  & Total & Flexible & Non-flex \\
\midrule
...
Week $24$ & -0.709** & -0.537** & -0.172 & Week $50+$ & -0.55 & -0.33 & -0.23 \\
          & (0.341)  & (0.248)  & (0.131) &            & (0.43) & (0.32) & (0.17) \\
...
\vspace{0.3cm}
\footnotesize
Notes: The table reports dynamic treatment effects relative to the week prior to treatment. Standard errors clustered at the household level are reported in parentheses. Week 50+ reports the average effect for all weeks beyond 50. Significance levels: ** $p<0.05$, * $p<0.10$.
